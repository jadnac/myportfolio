...
export function Hero() {
  return (
    <section className="section relative overflow-hidden">
      ...
      />
      <div className="relative mx-auto flex max-w-content flex-col items-start px-6 pb-20 pt-20 sm:pb-28 sm:pt-28">
        ...
        <div className="mt-9 flex flex-wrap items-center gap-4 animate-fadeUp [animation-delay:240ms]">
          <a
