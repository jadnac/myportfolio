    ...
    <section id="projects" className="section border-t border-border bg-surface">
      <div className="mx-auto max-w-content px-6 py-20 sm:py-28">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 [perspective:1000px]">
          {projects.map((p, i) => {
            const card = (
              <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-bg transition-colors group-hover:border-accent/50">
                <ProjectCover code={p.code} name={p.name} logo={p.logo} />
